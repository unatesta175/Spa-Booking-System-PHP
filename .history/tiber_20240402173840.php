...
function build_calendar($month, $year, $selectedStaff = null)
{
  ...
  // Initialize the options with the default option
$rooms = "<option value='' selected disabled>Pilih pakar terapi anda</option>";
  ...
  while ($currentDay <= $numberDays) {
    ...
    if ($dayName === 'tuesday') {
      ...
      if ($selectedStaff) {
        ...
        // If no staff is selected, disable the "Tempah" button and display an alert
        $calendar .= "<td class='$today'><h4>$currentDay</h4><button class='btns btn-success btn-xs' onclick='showAlert()'>Tempah</button><br> <span><i>Select a staff</i></span></td>";
      }
    }
...
<body>
    ...
    <div class="container ">
      <div class="row">
        <div class="col-md-12 ">
          ...
          echo build_calendar($month, $year, $selectedStaff);
  ...
  function showAlert() {
    Swal.fire({
      icon: 'error',
      title: 'Oops...',
      text: 'Please select a staff before booking.'
    });
  }
</script>
