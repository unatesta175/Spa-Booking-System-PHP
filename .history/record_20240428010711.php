                  ...
                  <div class="card-body">
                     ...
                     <div class="row">
                       ...
                       $pay_stat = $row['pay_stat'];
                               ...
                               <td>
      <a href="client-accounts.php?delete=' . $id . '" onclick="return confirm(\'Adakah anda pasti untuk buang akaun ini? Maklumat berkaitan pengguna ini akan dibuang!\');" class="tblbtn"><i style="margin: 0em 0.em;"class="fa fa-trash"></i>Delete</a>
