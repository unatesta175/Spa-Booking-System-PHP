                ...
                <div class="card card-default rounded-0 shadow">
                    <div class="card-body">
                        ...
                        <div style="margin: 1.5rem;">
                            ...
                            <a style="margin:1; font-size: 1.5em !important;" href="calendar.php" class="btns btn-warning"><i class="fas fa-calendar-days"></i> Lihat Tempahan di kalendar</a>
                            <a style="margin:1; font-size: 1.5em !important;" class="btns btn-warning" href="booking.php">
                        ...
                        <div class="col-sm-12 table-responsive">
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    $select_accounts = $conn->prepare("SELECT * FROM `bookings` ORDER BY datetimeapplied DESC");
                                    ...
                                    if ($select_accounts->rowCount() > 0) {
                                        while ($row = $select_accounts->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            $datetimeapplied= $row['datetimeapplied'];
                               ...
                               <td>
      <a href="booking-record.php?delete=' . $id . '" onclick="return confirm(\'Adakah anda pasti untuk batalkan tempahan ini?\');" class="tblbtn tblremove"><i style="margin: 0em 0.2em;"class="fa fa-ban"></i>Batal</a>
...
<script>
    $(document).ready(function() {
        var table = $('#table').DataTable({
            ...
            order: [[0, 'desc']] // Sort by first column (No Tempahan) in descending order
