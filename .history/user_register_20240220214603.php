...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert_user = $conn->prepare("INSERT INTO `clients`(name,ic, email, password,phoneno,datebirth,address,maritalstat,religion,occupation,company,fb,ig,allergy) VALUES(?,?,?)");
