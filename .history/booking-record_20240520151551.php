                           ...
                           if ($select_accounts->rowCount() > 0) {
                              while ($row = $select_accounts->fetch(PDO::FETCH_ASSOC)) {
                                 ...
                                 $eventTitle = "Sesi Rawatan " . $servicename . " di Kapas Spa Beauty";
                                  ...
                                  $gcal = "https://calendar.google.com/calendar/u/0/r/eventedit?text=" . $eventTitle  . "&dates=" . $date . "T" . $starttime . "/" . $date . "T" . $toTime . "&details=" . $link . "&location=" . $location . "&sf=true&output=xml";
