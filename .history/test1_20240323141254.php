    ...
    <div class="container mt-5 p-3"
      ...
      <form id="step3" style="display: none;">
        ...
        <div class="form-group">
          ...
          <input type="text" id="input3" name="input3" placeholder="Enter Input 3">
        </div>
        <button type="button" class="btns btn-secondarys prev">Previous</button>
    ...
    $(document).ready(function () {
        ...
        $('.next').click(function () {
            if (currentStep < 3) {
                ...
                // Update hidden inputs in form3 with values from form1 and form2
                if (currentStep === 1) {
                    nextForm.find('input[name="date"]').val(currentForm.find('input[name="date"]').val());
                    nextForm.find('input[name="time"]').val(currentForm.find('input[name="time"]').val());
                } else if (currentStep === 2) {
                    nextForm.find('input[name="remarks"]').val(currentForm.find('input[name="remarks"]').val());
                    nextForm.find('input[name="staff_id"]').val(currentForm.find('select[name="staff_id"]').val());
                    nextForm.find('input[name="service_id"]').val(currentForm.find('select[name="service_id"]').val());
                    nextForm.find('input[name="pay_type"]').val(currentForm.find('select[name="pay_type"]').val());
                }
