...
<body>
   ...
   <div class="section">
                        ...
                        <div class="col-sm-12 table-responsive">
                           <table id="myTable" class="table table-bordered table-striped">
                              ...
                              <tbody>
                               ...
                               $billcode = "your_billcode_here"; // Replace this with your actual billcode
      ...
      <a href="<?php echo $url; ?>" class="tblbtn tblpay"><i style="margin: 0em 0.2em;"class="fa fa-credit-card"></i>Bayar</a>
