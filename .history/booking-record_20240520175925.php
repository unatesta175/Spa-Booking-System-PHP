...
<div id="bruv" class="section">
  ...
  <a href="booking-record.php?delete=' . $id . '" onclick="return confirm(\'Adakah anda pasti untuk batalkan tempahan ini? Maklumat berkaitan pengguna ini akan dibuang!\');" class="tblbtn tblremove"><i style="margin: 0em 0.2em;"class="fa fa-ban"></i></a>
      <a href="https://toyyibpay.com/' . $billcode . '" class="tblbtn tblpay"  data-tippy-content="Batalkan Tempahan"><i style="margin: 0em 0.2em;"class="fa fa-credit-card"></i></a>
      <a href="' . $gcal . '" class="tblbtn tblx"  data-tippy-content="Batalkan Tempahan"><i style="margin: 0em 0.2em;"class="fab fa-google nav__icon"></i></a>
      </div>
      </td>
                               </tr>';
                                          $no++;
