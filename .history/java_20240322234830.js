// This event listener initializes the calendars when the DOM content is loaded
document.addEventListener('DOMContentLoaded', function () {
    // Retrieve date parameter from URL
    const urlParams = new URLSearchParams(window.location.search);
    const dateStr = urlParams.get('date');
 
    // Initialize calendar2
    ...
    var calendar2 = new FullCalendar.Calendar(calendarEl2, {
       ...
       events: [
          // PHP-generated events for calendar2 go here
       ],
    ...
    // This function navigates to the selected date on calendar2
    ...
    // This function handles booking a slot on calendar2
    ...
    var calendar1 = new FullCalendar.Calendar(calendarEl1, {
       // Configuration options for calendar1
    ...
    // This event listener handles mouseover events on calendar1
    ...
    // This event listener handles mouseout events on calendar1
