      ...
      <div class="container">
         ...
         <div class="row"
            ...
            <?php if (!empty($_GET['date']) && !empty($_GET['staff'])): ?>
               <h1 id="selectedDate" class="text-center">Tempah untuk tarikh : <?php echo date('m/d/Y', strtotime($date)); ?></h1>
               <?php
 ...
 <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('datepicker').addEventListener('change', function () {
            ...
            // Update the content of the <h1> element with the new date
            document.getElementById('selectedDate').textContent = 'Tempah untuk tarikh : ' + selectedDate;
