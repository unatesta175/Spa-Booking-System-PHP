...
if (isset($_POST['submit'])) {
   ...
   $starttime = htmlspecialchars(strip_tags(trim($starttime)), ENT_QUOTES, 'UTF-8');
   $endtime = $_POST['endtime'];
   $endtime = htmlspecialchars(strip_tags(trim($endtime)), ENT_QUOTES, 'UTF-8');
   $timeslot = $_POST['timeslot'];
   $staff_id = $_POST['staff_id'];
   $staff_id = htmlspecialchars(strip_tags(trim($staff_id)), ENT_QUOTES, 'UTF-8');
   $service_id = $_GET['service_id'];
   $service_id = htmlspecialchars(strip_tags(trim($service_id)), ENT_QUOTES, 'UTF-8');
