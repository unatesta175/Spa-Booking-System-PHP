...
<div style="display:flex;flex-direction: row;align-items: center;
   ...
   <a href="home.php"><img class=" underline"  style=" margin-top: 10px;
      ...
      <nav class="navbar">
         ...
         <a href="shop.php"class="underline">Rawatan & Pakej</a>
         <a href="shop.php"class="underline">Promosi</a>
         <a href="shop.php"class="underline">Produk</a>
         <a href="shop.php"class="underline">Gift Card</a>
         <a href="shop.php"class="underline">Credit</a>
      ...
      <div class="profile">
         ...
         <a href="change_password.php" class="option-btn">ubah kata laluan</a>
         <div class="flex-btn">
            <a href="user_register.php" class="option-btn">daftar</a>
            <a href="user_login.php" class="option-btn">log masuk</a>
         </div>
