   ...
   <div id="myModal" class="modal fade" role="dialog">
     ...
     <div style="border-radius:25px;"class="modal-content">
            <div class="modal-header" style="text-align: center;">
              ...
              <center><h2  style="margin:10px !important;  font-family: 'Gilroymedium', sans-serif !important;"class="modal-title">Tempah: <span id="slot"></h2></center>
               ...
               <div class="row">
                  <div class="modal-related col-md-12">
                     <form action="" method="post">
                        <div class="flex">
                        <div class="inputBox">
                              <label for="timeslot">Tarikh sesi rawatan:<span style="color: red;"></span></label>
                              <input type="text" readonly name="timeslot" required id="timeslot"
                                 class="box">
                           </div>
                           <div class="inputBox">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> <!-- Close button in the modal footer -->
            </div>
