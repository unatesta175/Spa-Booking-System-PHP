        ...
        $(document).ready(function() {
            $("#Submit").click(function(e) {
                ...
                if (client === "Pilih Pengguna" || date === "Date" || staff === "Pilih Pakar Terapi" || service === "Pilih Pakej Rawatan" || duration === "Tempoh Masa" || starttime === "") {
                    ...
                    var bookingInfo = "<strong>Tarikh:</strong> " + formattedDate + "<br>" +
                        "<strong>Pelanggan:" + clientname + "</strong> <br>" +
                    "<strong>Pakar Terapi:</strong> " + staffname + "</strong> <br>" +
                        "<strong>Rawatan:</strong> " + servicename + "</strong> <br>" +
                        "<strong>Tempoh Masa:</strong> " + duration + "</strong> <br>" +
                        "<strong>Slot Masa:</strong> " + formattedStartTime + " - " + formattedEndTime + "</strong> <br>";
