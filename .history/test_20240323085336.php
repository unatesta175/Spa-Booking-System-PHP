                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="remarks" required placeholder="Masukkan pesanan anda"
                                    maxlength="200" class="form-control" id="email">
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <select class="form-control" required placeholder="" name="staff_id">
                            ...
                            <div class="form-group ">
                                ...
                                <select class="form-control" required placeholder="Pilih Pakej Rawatan Anda" name="service_id">
                            ...
                            <div class="form-group ">
                                ...
                                <select class="form-control" required placeholder="" name="pay_type">
