...
<input type="text" id="otherOccupation" name="otherOccupation" style="display:none;"w placeholder="Masukkan pekerjaan anda" class="box">
    ...
    <label for="company">Nama Syarikat:<span style="color: red;">*</span> Tulis '-' jika tiada</label>
    <input type="text" id="company" name="company" required placeholder="Masukkan nama syarikat anda jika ada" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
    
    <label for="fb">Facebook Username:<span style="color: red;">*</span> Tulis '-' jika tiada</label>
    <input type="text" id="fb" name="fb" required placeholder="Masukkan username facebook anda jika ada" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
    
    <label for="ig">Instagram Username:<span style="color: red;">*</span> Tulis '-' jika tiada</label>
    <input type="text" id="ig" name="ig" required placeholder="Masukkan username instagram anda jika ada" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
   
    <label for="allergy">Alahan:<span style="color: red;">*</span> Tulis '-' jika tiada</label>
    ...
    <input type="submit"  value="daftar" class="btn" name="submit">
       <p>Sudah ada Akaun?</p>
      <a href="user-login.php" class="option-btn">Log Masuk Sekarang</a>
   </form>
...
function toggleOtherOccupationField() {
  ...
  if (occupationSelect.value === 'Lain-lain') {
    otherOccupationInput.style.display = 'block'; // Show the text input
  } else {
    otherOccupationInput.style.display = 'none'; // Hide the text input
    otherOccupationInput.value = ''; // Optionally clear the value
  }
}
</script>

<?php include '../components/stafffooter.php'; ?>
