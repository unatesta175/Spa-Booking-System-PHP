...
foreach ($existing_bookings as $booking) {
    if ($booking['staff_id'] == $staff_id) {
        ...
        // Extract start and end times from the existing booking
        list($existing_start, $existing_end) = explode(' - ', $booking['timeslot']);
        ...
        // Extract start and end times from the new booking
        list($new_start, $new_end) = explode(' - ', $timeslot);
        // Convert start and end times to timestamps for comparison
