...
localStorage.setItem('selectedDuration', formatDuration(duration);
});
...
window.addEventListener('load', function () {
    ...
    // Set the selected service ID in the dropdown
    if (selectedServiceId) {
        document.getElementById('service_id').value = selectedServiceId;
    }

    // Set the selected duration in the duration input
    if (selectedDuration) {
