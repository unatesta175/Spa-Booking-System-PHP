...
.flatpickr-innerContainer {
    ...
    .btns.baby.btn-success:hover {
        background-color: #28a745 !important; /* Change to a darker shade of green */
    }
    ...
    .form-group {
        flex: 0 0 calc(25% - 20px); /* Set the width of each button container to 50% */
...
<body>
   ...
   <div class="section">
      ...
      <div class="container">
        ...
        <!-- Inline calendar -->
        <div id="datepicker">
            <!-- Flatpickr inline calendar will be displayed here -->
        </div>
    </div>
 <div class="col-md-9 col-sm-6">
         ...
         <?php if (!empty($_GET['date']) && !empty($_GET['staff'])): ?>
             ...
             ?>
                 <div class='alert alert-secondary'>Kapas Spa Beauty tutup pada hari Selasa.</div>
             <?php } else { ?>
                 <h1 id="selectedDate" class="text-center" style="margin:20px; font-size:2rem;">Tempah untuk tarikh : <?php echo $_GET['date']; ?></h1>
                 <div class="timeslots-container" style="border:2px; border-color:black; margin-bottom:10px;max-height: 300px; overflow-y: auto; overflow-x: hidden; ">
                     <?php
                     ...
                     foreach ($timeslots as $ts) {
                         ...
                         ?>
                         <div style="margin:10px;" class="form-group m-3">
                             <?php
         ...
         <?php else: ?>
             <div class="col-md-12">
                 <br>
                 <div class='alert alert-secondary'>Sila pilih tarikh tempahan dan juga Pakar Terapi untuk melihat slot tempahan masa yang terbuka!</div>
             </div>
         <?php endif; ?>
         </div>

         <div class="container mt-3">
             <a href="service-package.php" class="btns btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
         </div>
     </div>
               ...
               <div class="row">
                  ...
                  $result = $conn->prepare("SELECT * FROM `services` WHERE id =?");
                       $result->execute([$_GET['service_id']]);
                           ...
                           <div class="inputBox ">
                              <label>Pakej Rawatan Spa :<span style="color: red;"></span></label>
                              <input class="box" required name="service_id" value="<?php echo $_GET['service_id']; ?>" readonly ><?php echo $namesv; ?>
      ...
      $(document).ready(function () {
         $(".book").click(function (event) {
            ...
            if (overlap) {
               ...
               alert("Tempahan sudah dibuat oleh Pengguna Lain.Sila pilih Slot masa yang lain");
            } else {
   ...
   <script>
      ...
      flatpickr('#datepicker', {
         ...
         inline: true, // Display Flatpickr inline instead of in a dropdown
