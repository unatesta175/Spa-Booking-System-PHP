...
<body>
   ...
   font-weight: 800 !important;">Tempah Sesi Rawatan</h1>
                    ...
                    <div class="section add-any">
                        <form style="box-shadow: none;" action="" method="post">
                            ...
                            <div class="inputBox">
                                ...
                                <input style="font-family: 'Gilroymedium', sans-serif;" style="font-size:1.3rem;" type="text" name="date" id=" class="box" placeholder="Date">
                            </div>
                            <div class="col-sm-2">
                                <label class="control-label col-sm-3 col-sm-offset-2">Pakar Terapi : </label>
                            ...
                            <div class="col-sm-2">
                                <label class="control-label col-sm-3 col-sm-offset-2">Pakej Rawatan Spa :</label>
                            ...
                            <div class="col-sm-2">
                                ...
                                <label class="control-label col-sm-3 col-sm-offset-2">Tempoh masa sesi rawatan: </label>
                ...
                <div class="col-md-8 col-sm-6" id='employee_div'></div>
