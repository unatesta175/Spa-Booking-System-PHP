...
if (isset($_POST['add_service'])) {
   ...
   if (!empty($_POST['extradetails'])) {
      ...
      foreach ($extradetails as $item) {
         $sanitizedDetails[] = htmlspecialchars(strip_tags(trim($item)), ENT_QUOTES, 'UTF-8');
      }
      ...
      <form action="" method="post" enctype="multipart/form-data">
         <div class="flex">
            <div class="inputBox">
               ...
               <input type="text" class="box" required maxlength="100" placeholder="Masukkan nama pakej rawatan" name="name">
            </div>
            <div class="inputBox">
               <label>Harga Pakej Rawatan : (RM)<span style="color: red;">*</span></label>
               <input type="text" class="box" required pattern="^\d*(\.\d+)?$" placeholder="Ex : 65/ 65.00 /65.50" onkeypress="if(this.value.length == 10 && !this.value.includes('.')) return false;" name="price">
            </div>
            ...
            <div class="inputBox">
               ...
               <textarea name="details" placeholder="Masukkan deskripsi pakej " class="box" maxlength="500" cols="30" rows="10"></textarea>
            </div>
         ...
         ?>
               <div class="box">
                  ...
                  <div class="flex-btn">
                     ...
                     <a href="services.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Buang pakej ini?');">Buang</a>
                  </div>
               </div>
         <?php
            }
