...
if (isset($_POST['submit'])) {
   ...
   if ($religion === 'Lain-lain') {
    ...
    if ($occupation === 'Lain-lain') {
     ...
     $updated_at = $currentDateTime; // Set updated_at to current datetime when profile is updated
   ...
   $update->execute([$name, $ic, $phoneno, $datebirth, $address, $maritalstat,$religion,$occupation,$company,$fb,$ig, $allergy,$updated_at, $user_id]);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (isset($_SESSION['update_success'])) {
        ...
        // Echo the JavaScript code to display the SweetAlert
        echo "Swal.fire({
                icon: 'success',
                title: 'Berjaya !',
                text: 'Anda berjaya kemaskini profil anda!',
