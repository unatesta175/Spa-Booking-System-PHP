...
<body>
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="height:40rem;">
                  ...
                  <div class="content">
                     ...
                     <br>
                     <a href="#comehere" class="btn">Lihat Pakej Sedia Ada</a>
                     <br>
                  </div>
               </div>
   ...
   <section id="comehere" class="service-category">
      ...
      <form action="" method="post" class="box ">
         ...
         <div class="row">
            ...
            <div class="content">
               ...
               <div class="flex-btn">
                  <input type="submit" value="Lihat Pakej Sedia Ada" class="btn" name="add_to_cart">
