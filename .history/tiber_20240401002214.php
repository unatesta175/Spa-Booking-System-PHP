...
function build_calendar($month, $year)
{
  ...
  while ($currentDay <= $numberDays) {
    ...
    if ($date < date('Y-m-d')) {
      ...
      $calendar .= "<td ><h4>$currentDay</h4><a class='btns btn-danger btn-xs'>Already Booked</a></td>";
    } else {
      // Display an available date
      $calendar .= "<td class='$today'><h4>$currentDay</h4><a href='book.php?date=" . $date . "'class='btns btn-success btn-xs'>Book</a></td>";
    }
...
.btn-success{ background-colorcolor:#2adb89 !important;}
  </style>
</head>
