...
<body>
   ...
   <div class="section">
                        ...
                        <div class="col-sm-12 table-responsive">
                           <table id="myTable" class="table table-bordered table-striped">
                              ...
                              <tbody>
                               ...
                               $billcode = "8aw4qo6k"; // Replace this with your actual billcode
      ...
      <a href="<?php echo 'https://toyyibpay.com/' . $billcode; ?>"class="tblbtn tblpay"><i style="margin: 0em 0.2em;"class="fa fa-credit-card"></i>Bayar</a>
