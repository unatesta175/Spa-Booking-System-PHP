...
function build_calendar($month, $year)
{
  ...
  while ($currentDay <= $numberDays) {
    ...
    if ($dayName === 'tuesday' && $date > date('Y-m-d')) {
      ...
      $calendar .= "<td class='$today'><h4>$currentDay</h4><a href='timeslot.php?date=" . $date . "'class='btns btn-success btn-xs'>Tempah</a> <span style="">$availableslots slots left</span></td>";
