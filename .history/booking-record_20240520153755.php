                        ...
                        <tbody>
                           ...
                           if ($select_accounts->rowCount() > 0) {
                              while ($row = $select_accounts->fetch(PDO::FETCH_ASSOC)) {
                                 ...
                                 $eventTitle = urlencode("Your Event Title");
                                 $details = urlencode("Event Details");
                                 $location = urlencode("Sesi Rawatan " . $servicename . " di Kapas Spa Beauty");

                                 // Build the Google Calendar URL
                                 $gcal = "https://calendar.google.com/calendar/u/0/r/eventedit?text=" . $eventTitle  . "&dates=" . $dates . "T" . $starttime . "/" . $date . "T" . $endtime . "&details=" . $details . "&location=" . $location . "&sf=true&output=xml";
