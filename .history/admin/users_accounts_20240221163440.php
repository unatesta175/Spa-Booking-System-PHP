...
<script>
    document.getElementById("csv-btn").addEventListener("click", function () {
        ...
        downloadLink.setAttribute("download", "Client Data.csv"); // Set the file name for download
...
document.getElementById("pdf-btn").addEventListener("click", function () {
    ...
    // Example table data
    // In a real scenario, you'd collect this data from your table
    ...
    // Optionally, you can customize the appearance of the table
    doc.autoTable({
        head: head,
        body: body,
        didDrawCell: (data) => {
        ...
        margin: { top: 20 }, // Adjust margins to fit your needs
        theme: 'grid', // Choose a theme ('striped', 'grid', 'plain', 'css')
