    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function toggleStaffDropdown() {
                ...
                var staffDropdown = $("#depart_dropdown"); // Get staff dropdown element
                var desigDropdown = $("#desig_dropdown"); 
                
                // Check if date value is set
                if (dateValue && dateValue !== "---Select---") {
                    ...
                    desigDropdown.prop("disabled", true);
            ...
            function toggleDesigDropdown() {
                var staffDropdown = $("#depart_dropdown").val(); // Get date input value
                var desigDropdown = $("#desig_dropdown"); // Get staff dropdown element

                // Check if date value is set
                if (staffDropdown  && dateValue !== "---Select---") {
                    // Date is set, enable staff dropdown
                    desigDropdown.prop("disabled", false);
                } else {
                    // Date is not set, disable staff dropdown and reset its value
                    desigDropdown.prop("disabled", true);
                    // Reset staff dropdown value
            ...
            $("#date").change(function() {
                ...
                $("#depart_dropdown").val("---Select---"); // Reset staff dropdown value
        ...
        <div class="container">
            ...
            <div class="row">
                <form method="post" class="form-horizontal">
                    ...
                    <label for="price" class="control-label col-sm-3 col-sm-offset-2">Staff: </label>
                    <div class="col-sm-2">
