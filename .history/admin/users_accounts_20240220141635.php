      ...
      if($select_accounts->rowCount() > 0){
         while($row = $select_accounts->fetch(PDO::FETCH_ASSOC)){
                							...
                							<td>' . $email . '</td>
               								...
               								<td>
                                       <center><a class=" underline" style="font-size: 1.5em;" href="users_accounts.php?delete=' . $id . '" onclick="return confirm(`Buang Maklumat Permohonan?`);" title="Buang Pemohonan"> <center><i class=" fa fa-trash" style="color:red">
                                       </i></center></a>&nbsp;&nbsp;&nbsp;&nbsp;</center>
											</td>
                							</tr>';
											$no++;
