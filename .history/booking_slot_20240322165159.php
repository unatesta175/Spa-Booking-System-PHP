...
/* CSS for hovered empty time slots */
.empty-slot.hovered {
   ...
   document.addEventListener('DOMContentLoaded', function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventAdd: function (info) {
            // Add custom CSS class to empty time slots
            if (!info.event) {
                info.el.classList.add('empty-slot');
            }
        }
    });
    ...
    // Add mouse hover effect for empty time slots
    $(document).on('mouseover', '.empty-slot', function () {
        $(this).addClass('hovered');
    });

    $(document).on('mouseout', '.empty-slot', function () {
