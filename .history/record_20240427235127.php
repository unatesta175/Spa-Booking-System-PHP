                        ...
                        <div class="col-sm-12 table-responsive">
                           <table id="myTable" class="table table-bordered table-striped">
                              ...
                              <tbody>
                               ...
                               <td>
                               <?php if ($pay_stat == "Belum Bayar"): ?>
                                   <button class="tblbtn"><?php echo $pay_stat; ?></button>
                               <?php elseif ($pay_stat == "Telah Dibayar"): ?>
                                   <button class="greenbtn"><?php echo $pay_stat; ?></button>
                               <?php endif; ?>
                           </td>
