      ...
      <div class="container">
         ...
         <div class="row"
            ...
            foreach ($timeslots as $ts) {
               ...
               $isBooked = in_array($ts, array_column($existingBookings, 'timeslot'));
           
               // Set button class and attributes based on booked status
               $buttonClass = $isBooked ? 'btn-danger' : 'btn-success';
               $buttonDataAttr = $isBooked ? 'disabled' : '';
           
               // Output the button with the appropriate class and attributes
               ?>
               <div class="col-md-2">
                   <div class="form-group m-3">
                       <button class="btns <?php echo $buttonClass; ?> book" data-timeslot="<?php echo $ts; ?>" <?php echo $buttonDataAttr; ?>>
                           <?php echo $ts; ?>
                       </button>
                   </div>
               </div>
