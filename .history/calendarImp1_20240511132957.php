...
<head>
   ...
   <!-- <style>
      ...
      .fc table { /* day type header label */
      ...
      .fc .fc-col-header-cell-cushion { /* day type header label */
         display: inline-block;
         padding: 2px 4px;
         text-decoration: none;
         color: rgb(141 149 168);
      ...
      .fc .fc-daygrid-day-number {/* Day number in dayGridMonth view */
         padding: 4px;
         position: relative;
         z-index: 4;
         text-decoration: none;
      ...
      .fc-header-toolbar, /* Header buttons */
        .fc-day-header, /* Day names (e.g., "Sun", "Mon") */
        .fc-time-grid-event, /* Events in the time grid */
        .fc-list-item-time, /* Time for list view */
        
        .fc-list-item-title, /* Title for list view */
        .fc-event-title /* Title of events */ {
            font-size: 1.4rem; /* Adjust font size as needed */
        }
        
 /*timeslot timegridday */
      ...
      alert('selected ' + info.startStr + ' to ' + info.endStr);
                ...
                events: [
                                    ...
                                    while ($booking = $bookings_query->fetch(PDO::FETCH_ASSOC)) {
                                       ...
                                       $titlebk = $booking['service_id'];

                                       $bookings_query1 = $conn->prepare("SELECT * FROM `bookings`");
                                    $bookings_query1->execute();
                                    while ($booking = $bookings_query1->fetch(PDO::FETCH_ASSOC)) {
        ...
        timeFormat: { // Format the time to display like "10 am"
            hour: '2-digit',
            minute: '2-digit',
            meridiem: false // Disables displaying AM/PM
        }
