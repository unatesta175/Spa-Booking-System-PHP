...
if (isset($_POST['submit'])) {
    ...
    $updated_at = $currentDateTime; // Set updated_at to current datetime for new registration
    ...
    if ($select_user->rowCount() > 0) {
        ...
        $_SESSION['booking_success'] = 3; // Successfully registered
    } else {
        if ($pass != $cpass) {

            $_SESSION['booking_success'] = 2; // Successfully registered
        } else {
            $insert_user = $conn->prepare("INSERT INTO `clients`(name,ic, email, password,phoneno,datebirth,address,maritalstat,religion,occupation,company,fb,ig,allergy,datetimeregistered,updated_at) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            $insert_user->execute([$name, $ic, $email, $cpass, $phoneno, $datebirth, $address, $maritalstat, $religion, $occupation, $company, $fb, $ig, $allergy, $currentDateTime, $defaultDateTime]);
    ...
    if ($_SESSION['booking_success'] == 1) {
        $SuccessScript = "<script>
            window.onload = function() {
                Swal.fire({
                    title: 'Berjaya!',
                    text: 'Pengguna berjaya didaftar!',
                    icon: 'success',
...
<div id="bruv" class="section">
    <div class="container">
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div style="margin: 1.5rem;">
                            <button type="button" class="btns btn-warning" data-toggle="modal" data-target="#myModal">
                                <i style="margin: 0em 0.2em;" class="fa fa-user-plus"></i>Daftar Pengguna
                            </button>
                        </div>
            ...
            <a href="update-client.php?update=' . $id . '"  class="tblbtn tbledit"><i style="margin: 0em 0.2em;"class="fa fa-pen"></i>Kemaskini</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Maklumat pengguna baru</h4>
        ...
        $(document).on("click", "#view_btn", function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#edit_maritalstat').val(data.maritalstat);
                ...
                <form action="" style="box-shadow:none;" method="post">
                    <div class="flex">
                        <div class="inputBox">
                            ...
                            <input type="text" readonly id="edit_name" required placeholder="-" maxlength="70" class="box">
                        </div>

                        <div class="inputBox">
                            <label for="email">Emel :</label>
                            <input type="email" readonly disabled id="edit_email" required placeholder="-" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
                        </div>
                  

                        <div class="inputBox">
                            <label>Nombor telefon :</label>
                            <input type="text" readonly  id="edit_phoneno"  required placeholder="-" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
                        </div>
                        <div class="inputBox">
                        ...
                        <div class="inputBox">
                            <label for="address">Alamat Kediaman :<span style="color: red;"></span></label>
                            <input type="text" readonly id="edit_address"  required placeholder="-" maxlength="70" class="box">
                        </div>
                        <div class="inputBox">
                            <label for="address">Status Perkahwinan :<span style="color: red;"></span></label>
                            <input type="text" readonly id="edit_maritalstat"  required placeholder="-" maxlength="70" class="box">
                        </div>
                        <div class="inputBox">
                            <label for="address">Agama :<span style="color: red;"></span></label>
                            <input type="text" readonly id="edit_religion"  required placeholder="-" maxlength="70" class="box">
                        </div>
                        <div class="inputBox">
                            <label for="address">Pekerjaan</label> :<span style="color: red;"></span></label>
                            <input type="text" readonly id="edit_occupation"  required placeholder="-" maxlength="70" class="box">
                        </div>
                        <div class="inputBox">
                            <label for="address">Nama Syarikat :<span style="color: red;"></span></label>
                            <input type="text" readonly id="edit_company"  required placeholder="-" maxlength="70" class="box">
                        </div>
                        <div class="inputBox">
                            <label for="address">Link Facebook :<span style="color: red;"></span></label>
                            <input type="text" readonly id="edit_fb"  required placeholder="-" maxlength="70" class="box">
                        </div>
                        <div class="inputBox">
                            <label for="address">Link Instagram :<span style="color: red;"></span></label>
                            <input type="text" readonly id="edit_ig"  required placeholder="-" maxlength="70" class="box">
                        </div>
                        <div class="inputBox">
                            <label for="address">Alahan :<span style="color: red;"></span></label>
                            <input type="text" readonly id="edit_allergy"  required placeholder="-" maxlength="70" class="box">
                        </div>
