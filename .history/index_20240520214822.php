...
<section class="home">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img class="lazy lazy-placeholder" src="images/h1.png" alt="">
         </div>
         <div class="content">
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img class="lazy lazy-placeholder" src="images/h2.png" alt="">
         </div>
         <div class="content">
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img class="lazy lazy-placeholder" src="images/h4.png" alt="">
         </div>
         <div class="content">
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img class="lazy lazy-placeholder" src="images/h5.png" alt="">
         </div>
         <div class="content">
...
<section class="home-products">
   ...
   <form action="" method="post" class="swiper-slide slide">
      ...
      <img class="lazy lazy-placeholder" src="uploaded_img/<?= $fetch_product['image_01']; ?>" alt="">
...
<section class="home-products">
   ...
   <?php
      ...
      echo '<p class="empty">Tiada produk!</p>';
   }
   ?>
...
<section class="home-products">
   ...
   <?php
      ...
      echo '<p class="empty">Tiada Promo!</p>';
   }
   ?>
