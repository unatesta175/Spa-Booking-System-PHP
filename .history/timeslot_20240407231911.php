...
<body>
         ...
         <h1 class="text-center">Tempah untuk tarikh :
            ...
            <form>
               ...
               <div class="inputBox">
                  ...
                  <input readonly style="font-size:1.3rem;" type="text" name="duration" id="duration" class="box"
   ...
   <script>
      ...
      document.getElementById('service_id').addEventListener('change', function() {
        ...
        // Get the duration data attribute value from the selected option
        var duration = selectedOption.dataset.duration;
        
        // Format the duration using the formatDuration function
        var formattedDuration = formatDuration(duration);
        
        // Update the value of the duration input field
