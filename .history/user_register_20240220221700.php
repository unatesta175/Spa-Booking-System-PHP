...
<section class="form-container">
   ...
   <form action="" method="post">
    ...
    <input type="text" id="company" name="company"  required placeholder="Masukkan nama syarikat anda" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
