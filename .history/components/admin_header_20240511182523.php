...
<header class="header">
   ...
   <section class="flex">
      ...
      <nav class="navbar">
         ...
         <a href="../admin/booking-record.php">home</a>
      ...
      <div class="profile">
         ...
         <a href="../admin/update-profile.php" class="btnx">kemaskini profil</a>
         ...
         <a href="../components/admin_logout.php" class="delete-btn" onclick="return confirm('logout from the website?');">log keluar</a> 
      </div>
