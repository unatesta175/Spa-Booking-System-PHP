...
<body>
   ...
   <script>
    ...
    if (currentUrl.includes('?')) {
        // If the URL already contains query parameters, append the staff parameter
        var newUrl = currentUrl + '&staff=' + selectedStaffId;
    } else {
        // If the URL does not contain any query parameters, append the staff parameter with a '?' prefix
        var newUrl = currentUrl + '?staff=' + selectedStaffId;
    }
   ...
   <script>
    ...
    document.getElementById('datepicker').addEventListener('change', function() {
        ...
        // Check if the URL already contains query parameters
        if (currentUrl.includes('?')) {
            // If the URL already contains query parameters, append the date parameter
            var newUrl = currentUrl + '&date=' + selectedDate;
        } else {
            // If the URL does not contain any query parameters, append the date parameter with a '?' prefix
            var newUrl = currentUrl + '?date=' + selectedDate;
        }
