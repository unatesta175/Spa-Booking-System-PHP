...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function setInitialValuesFromLocalStorage() {
        ...
        // Set the service ID value in the select element
        if (storedServiceId) {
            document.getElementById('service_id').value = storedServiceId;
        }
    }

    // Call the function to set initial values from localStorage
