...
<select id="religion" name="religion" required class="box">
  <option value="">--Masukkan Agama Anda--</option>
  <option value="Islam">Islam</option>
  <option value="Kristen">Kristian</option>
...
<!-- Hidden text input for "Lainnya" option -->
<input type="text" id="otherReligion" name="otherReligion" placeholder="Masukkan agama anda" class="box" style="display:none;" oninput="updateReligionValue()">
...
function toggleOtherReligionField() {
  // Get the select dropdown and the text input elements
...
(religionSelect.value === 'Lain-lain') {
    // Show the text input
...
function updateReligionValue() {
  // Get the text input and the select elements
  var otherReligionInput = document.getElementById('otherReligion');
  var religionSelect = document.getElementById('religion');

  // Update the value of the select to the text input's value if "Lainnya" is selected
  if(religionSelect.value === 'Lainnya') {
    religionSelect.value = otherReligionInput.value;
  }
}
</script>
