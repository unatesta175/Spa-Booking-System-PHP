...
if (isset($_GET['service_id'])) {
   ...
   <script>
      ...
      <div class="fc-event-main-frame"><div class="fc-event-time">11:00 - 1:30</div><div class="fc-event-title-container"><div class="fc-event-title fc-sticky">Booked Slot</div></div></div>
