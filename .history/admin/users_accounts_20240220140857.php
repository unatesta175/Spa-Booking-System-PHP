      ...
      if($select_accounts->rowCount() > 0){
         while($row = $select_accounts->fetch(PDO::FETCH_ASSOC)){
											...
											<center>
												...
												<php? <button> <a href="application_delete.php?delete=' . $id . '" onclick="return confirm('delete this account? the user related information will also be delete!')" class="delete-btn">delete</a></button>
											</center>
											</td>        
                							echo'</tr>';
											$no++;
