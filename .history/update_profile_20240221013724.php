...
if (isset($_POST['submit'])) {
   ...
   $update = $conn->prepare("UPDATE `clients` SET name = ?, ic = ?, email = ?, password = ?, phoneno = ? ,faculty_id = ? , datebirth= ? , address= ? , maritalstat= ?, religion= ?, occupation= ?, company= ?, fb= ?, ig= ?, company= ?WHERE student_id = ?");
