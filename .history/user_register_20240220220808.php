...
<section class="form-container">
   ...
   <form action="" method="post">
    ...
    <input type="text" id="name" name="name" style="text-transform:capitalize; required placeholder="Masukkan emel anda""" maxlength="70" class="box">
    ...
    <input type="text" id="phoneno" name="phoneno"  required placeholder="Masukkan nombor kad pengenalan anda" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
    ...
    <input type="text" id="maritalstat" name="maritalstat"  required placeholder="ex:020830101563" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
