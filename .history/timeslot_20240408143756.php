...
<body>
            ...
            <form>
               ...
               <div class="inputBox ">
                  ...
                  <select class="box" required placeholder="" name="staff_id" id="staff_id">
                     <option value="" <?php echo isset($_GET['staff']) ? '' : 'selected'; ?>>Sila Pilih Pakar Terapi
                        Anda</option>
                     <?php
   ...
   // Show loading overlay and spinner when the page is reloading
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Function to hide loading overlay and spinner after a delay
  function hideLoading() {
    loadingOverlay.style.display = 'none';
    loadingSpinner.style.display = 'none';
  }

  // Hide loading overlay and spinner after 5 seconds (5000 milliseconds)
  setTimeout(hideLoading, 5000);
});

// Hide loading overlay and spinner when the page has finished reloading
