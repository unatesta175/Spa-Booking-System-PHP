...
if (isset($_POST['submit'])) {
   ...
   if ($stmt->rowCount() > 0) {
      $msg = "<div class='alert alert-danger'>Sudah Ditempah!</div>";
   } else {
      ...
      // Set success message
      $msg = "<div class='alert alert-success'>Anda berjaya membuat tempahan!</div>";
   }
...
<body>
 ...
 <div class="section">
   ...
   <div class="container">
      ...
      <a href="javascript:void(0);" onclick="goBack()" class="btns btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
