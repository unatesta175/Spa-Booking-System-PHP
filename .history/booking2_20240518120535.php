                ...
                <div class="col-md-4 col-sm-6">
                    <div class="section add-any">
                        <form id="registration_form" style="box-shadow: none;" action="javascript:void(0)" method="post">
                            ...
                            <input name="service" hidden required value="<?php echo $user_id; ?>" id="service">

                            <div class="inputBox">
                                <label>Pakej Rawatan Spa :</label>
                                <select name="servicetiber"  placeholder="Pilih Pakej Rawatan" class="box" id="servicetiber">
