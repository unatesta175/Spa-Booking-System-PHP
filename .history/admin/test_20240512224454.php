...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function loadDataByDate(dateValue) {
        // Make an AJAX request to the current page with the date value
        $.ajax({
            url: window.location.href, // Current page URL
            method: "POST",
            data: { date: dateValue }, // Date value to send
            success: function(response) {
                // Handle the response (if needed)
                // For example, update the content of a specific div
                $("#desig_div").html(response);
            },
            ...
            function toggleStaffDropdown() {
                ...
                if (dateValue) {
                    ...
                    staffDropdown.val(""); // Reset staff dropdown value
                }
            }
        ...
        // Call the function to load data based on the selected date
