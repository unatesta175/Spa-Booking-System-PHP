         ...
         <form action="" method="post">
            ...
            if ($result->rowCount() > 0) {
               while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                  $name, $ic,$email, $phoneno, $datebirth, $address, $maritalstat,$religion,$occupation,$company,$fb,$ig, $allergy

                  $name = $row['name'];
                  $ic = $row['ic'];
                  $email = $row['email'];
                  $phoneno = $row['phone_no'];
                  $datebirth = $row['phone_no'];
                  $address = $row['phone_no'];
                  $maritalstat = $row['phone_no'];
                  $religion = $row['phone_no'];
                  $occupation = $row['phone_no'];
                  $company = $row['phone_no'];
                  $fb = $row['phone_no'];
                  $ig = $row['phone_no'];
                  $allergy = $row['phone_no'];
               }
            }
            ?>
