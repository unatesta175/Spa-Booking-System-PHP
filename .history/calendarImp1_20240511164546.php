      ...
      document.addEventListener('DOMContentLoaded', function() {
         ...
         var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            if (eventsInSlot.length === 0) {
                var startTime = info.date.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: true });
                showTooltip(info.jsEvent, startTime);
            }
        }
            events: [
               <?php
         ...
         calendar.render();
         function showTooltip(jsEvent, text) {
        ...
        jsEvent.target.addEventListener('mouseleave', function() {
