...
<div id="bruv" class="section">
   <div class="container">
      ...
      <a href="https://toyyibpay.com/' . $billcode . '" class="tblbtn tblpay"><i style="margin: 0em 0.2em;"class="fa fa-credit-card"></i>Bayar</a>
      </td>  $gcal = "https://calendar.google.com/calendar/u/0/r/eventedit?text=" . $eventTitle  . "&dates=" . $date . "T" . $fromTime . "/" . $date . "T" . $toTime . "&details=" . $link . "&location=" . $location . "&sf=true&output=xml";
