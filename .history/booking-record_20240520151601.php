...
<div id="bruv" class="section">
   <div class="container">
                           ...
                           if ($select_accounts->rowCount() > 0) {
                              while ($row = $select_accounts->fetch(PDO::FETCH_ASSOC)) {
                                 ...
                                 $eventTitle = "Sesi Rawatan " . $servicename . " di Kapas Spa Beauty";
                                  ...
                                  $gcal = "https://calendar.google.com/calendar/u/0/r/eventedit?text=" . $eventTitle  . "&dates=" . $date . "T" . $starttime . "/" . $date . "T" . $endtime . "&details=" . $link . "&location=" . $location . "&sf=true&output=xml";
      ...
      <a href="'. $gcal . '" class="tblbtn tblpay"><i style="margin: 0em 0.2em;"class="fa fa-credit-card"></i>Bayar</a>
