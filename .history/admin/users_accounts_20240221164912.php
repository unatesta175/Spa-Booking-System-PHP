	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card card-default rounded-0 shadow">
				...
				<div class="card-body">
					<button class="option-btn"id="export-btn">Eksport ke Excel</button>
               <button class="option-btn"id="pdf-btn">Eksport ke PDF</button>
					<div class="row">
...
document.getElementById("pdf-btn").addEventListener("click", function () {
    ...
    const headers = [["No.", "ID Pengguna", "Nama Pengguna", "Email", "Tindakan"]];
    ...
    document.querySelectorAll("#myTable tbody tr").forEach(function(row, index) {
        ...
        row.querySelectorAll("td").forEach(function(cell) {
            // Exclude the action column or modify as needed
            if (cell.cellIndex < 4) { // Assuming the 'Tindakan' column is the last one
    ...
    doc.autoTable({
        head: headers,
        body: data,
        theme: 'plain', // 'plain' theme for a more formal look; customize further as needed
        styles: {
        font: 'helvetica',
        fontSize: 10,
        cellPadding: 5,
    ...
    headStyles: {
        ...
        textColor: [0, 0, 0],
        fontStyle: 'bold',
        lineColor: [0, 0, 0], // Ensure header cells also have lines
        lineWidth: 0.1, // Specify line width for header cells
    },
    ...
    // Optionally set document properties for a more professional look
    doc.setProperties({
        title: 'Senarai Pengguna',
        subject: 'Senarai Pengguna PDF Export',
        author: 'Your Organization',
        keywords: 'pdf jspdf autotable',
