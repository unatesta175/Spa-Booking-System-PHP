...
<section class="form-container">
   ...
   <form action="" method="post">
    ...
    <input type="text" id="ic" name="datebirth"  required placeholder="Masukkan nombor kad pengenalan anda" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
