...
$totalbookings = checkSlots($conn, $date,$selectedStaff);
        if ($totalbookings == 36) {
            ...
            $availableslots = 36 - $totalbookings;
            $calendar .= "<td class='$today'><h4>$currentDay</h4><a href='timeslot.php?date&staff=$selectedStaff'class='btns btn-success btn-xs'>Tempah</a><br> <span><i>$availableslots slots left</i></span></td>";
