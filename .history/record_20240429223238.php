...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
                     ...
                     <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle page-scroll" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Muhammad Ilyas bin Amran</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="/profil"><span class="item-text">PROFIL</span></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="/rekod"><span class="item-text">REKOD TEMPAHAN</span></a>
                            <div class="dropdown-divider"></div>
