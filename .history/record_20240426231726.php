            ...
            <div class="col-md-4 col-sm-6">
               ...
               <form style="box-shadow: none;" action="" method="post">
                     ...
                     <div class="inputBox ">
                        ...
                        <select style="appearance: none; " disabled class="box" name="service_id" id="service_id" onchange="updateUrlWithServiceDetails()">
                           <option value="<?php echo $_GET['service_id']; ?>" selected data-duration='<?php echo $durationsv+30;?>'>
                     ...
                     <div class="inputBox">
                        ...
                        <input aria-readonly style="font-family: 'Gilroymedium', sans-serif;" readonly
                           ...
                           name="timeslot" id="timeslotz" class="box" placeholder="Slot Masa">
                     </div>
