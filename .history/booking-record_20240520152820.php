...
<div id="bruv" class="section">
   <div class="container">
                        ...
                        <tbody>
                           ...
                           if ($select_accounts->rowCount() > 0) {
                              while ($row = $select_accounts->fetch(PDO::FETCH_ASSOC)) {
                                 ...
                                 $eventTitle = urlencode($eventTitle);
                                 $details = urlencode($details);
                                 $location = urlencode($location);
                                 
                                 // Example datetime values from your database
                                 $dateTimeStart = '2024-05-20 14:30:00';
                                 $dateTimeEnd = '2024-05-20 15:30:00';
                                 ...
                                 $dateStart = $startDateTime->format('Ymd');
                                 $timeStart = $startDateTime->format('His');
                                 $dateEnd = $endDateTime->format('Ymd');
                                 $timeEnd = $endDateTime->format('His');
                                 
                                 // Construct the Google Calendar URL
                                 $gcal = "https://calendar.google.com/calendar/u/0/r/eventedit?text={$eventTitle}&dates={$dateStart}T{$timeStart}/{$dateEnd}T{$timeEnd}&details={$details}&location={$location}&sf=true&output=xml";
      ...
      <a href="'. $gcal . '" class="tblbtn tblpay"><i style="margin: 0em 0.2em;"class="fab fa-google nav__icon"></i>Google Calendar</a>
