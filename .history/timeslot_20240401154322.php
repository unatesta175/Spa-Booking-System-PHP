...
<body>
   ...
   <slot?php include 'components/user-header.php' ; ?>
            ...
            foreach ($timeslots as $ts) {
               ...
               <div class="col-md-2">
                  <div class="form-group m-3">
                     <button class="btns btn-success" data-timeslot="<!-- Trigger the modal with a button -->
      ...
      <div id="myModal" class="modal fade" role="dialog">
         <div class="modal-dialog">
            ...
            <div class="modal-content">
               <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Tempah: <span id="slot"></slot>
                  </h4>
               </div>
               <div class="modal-body">
                  <div class="row">
                     <div class="col-md-12">
                        <form action="" method="post">
                           ...
                           <div class="form-group">
                              ...
                              <input required type="text" readonly name="name" id="timeslot" class="form-control">
                           </div>
                           <div class="form-group">
                              <label for="">Email</label>
                              <input required type="email" readonly name="email" id="timeslot" class="form-control">
                           </div>
                        </form>
                     </div>
                  </div>
