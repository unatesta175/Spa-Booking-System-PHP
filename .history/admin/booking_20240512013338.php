...
<body>
                    ...
                    <div class="section add-any">
                        <form style="box-shadow: none;" action="" method="post">
                            ...
                            <div class="inputBox ">
                                ...
                                <select required placeholder="" class="box" name="service_id" id="service_id" >
                                    <option value="" data-duration='<?php echo $durationsv + 30; ?>' selected>Sila Pilih Pakej Rawatan Anda </option>
                                    <?php
   ...
   <script>
      localStorage.setItem('selectedServiceId', "");
      document.addEventListener('DOMContentLoaded', function() {
