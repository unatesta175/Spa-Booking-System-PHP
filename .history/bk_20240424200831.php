    ...
    <div class="container">
        <div class="section add-any">
            <form id="bookingForm">
                ...
                <div class="inputBox">
                    <label for="name">Tarikh sesi rawatan:</label>
                    <input style="font-family: 'Gilroymedium', sans-serif;" readonly style="font-size:1.3rem;" type="date" name="duration" id="duration" class="box" placeholder="Duration">
                </div>
                <div class="inputBox">
