         ...
         <h1 class="text-center">Tempah untuk tarikh :
            ...
            <form>
               ...
               <div class="inputBox">
                  ...
                  <input style="font-family: 'Gilroymedium', sans-serif;"readonly style="font-size:1.3rem;" type="text" name="duration" id="duration" class="box"
...
<div class="row" style="background-color:white;  border-radius: 25px; padding:10px; box-shadow: var(--box-shadow);">
            <div class="col-md-12">
   ...
   <script>
      ...
      document.getElementById('staff_id').addEventListener('change', function () {
         ...
         xhr.open('GET', 'timeslot.php?staff=' + selectedStaffId + '&date=' + currentDate, true);
         xhr.send();
