            ...
            <form>
               ...
               <div class="inputBox ">
                  ...
                  <select class="box" required placeholder="" name="staff_id" id="staff_id">
                     <option value="Sila Pilih Pakar Terapi Anda" selected hidden>Sila Pilih Pakar Terapi Anda</option>
                     <?php
...
foreach ($timeslots as $ts) {
    ...
    <div class="col-md-2">
        <div class="form-group m-3">
            <?php if ($isBooked) { ?>
                <button class="btns btn-danger book" data-timeslot="<?php echo $ts; ?>" disabled>
                    <?php echo $ts; ?>
                </button>
            <?php } else { ?>
