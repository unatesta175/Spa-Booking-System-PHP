      ...
      document.addEventListener('DOMContentLoaded', function () {
         ...
         var calendar2 = new FullCalendar.Calendar(calendarEl2, {
            ...
            events: [
               ...
               $current_date->setTimestamp(strtotime('next Tuesday'));
               $current_date_str = $current_date->format('Y-m-d');

               while ($current_date->format('l') === 'Tuesday') {
                  echo "{";
                  echo "title: 'No Available Booking',";
                  echo "start: '" . $current_date_str . "',";
                  echo "allDay: true,"; // Set to true to make it an all-day event
                  echo "editable: false,"; // Set to false to prevent clicking
                  echo "color: '#CCCCCC'"; // Customize color to visually distinguish it
                  echo "},";
