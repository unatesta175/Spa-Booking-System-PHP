	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card card-default rounded-0 shadow">
				...
				<div class="card-body">
					<button class="option-btn"id="export-btn">Eksport ke Excel</button><br><br>
					<div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card card-default rounded-0 shadow">
                        ...
                        <div class="card-body">
                          ...
                          40%;><span style="color: black;"">** </span><i>Maklumat kuliah/kelas <span style="color: black;"><b>tidak boleh diubah</b> </span> setelah permohonan disemak.</i></h6>
