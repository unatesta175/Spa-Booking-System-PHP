...
<section class="form-container">
   ...
   <form action="" method="post">
    ...
    <label for="maritalstatus">Status Perkahwinan:<span style="color: red;">*</span></label>
...
<input type="text" id="otherOccupation" name="otherOccupation" style="display:none;" placeholder="Masukkan pekerjaan anda" class="box">
    ...
    <label for="company">Nama Syarikat: Biarkan kosong jika tiada</label>
    ...
    <label for="fb">Facebook Username: Biarkan kosong jika tiada</label>
    ...
    <label for="ig">Instagram Username: Biarkan kosong jika tiada</label>
