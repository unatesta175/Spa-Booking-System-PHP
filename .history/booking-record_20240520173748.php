...
<div id="bruv" class="section">
  ...
  <div class="button-container">
    <a href="booking-record.php?delete=<?php echo $id; ?>" onclick="return confirm('Adakah anda pasti untuk batalkan tempahan ini? Maklumat berkaitan pengguna ini akan dibuang!');" class="tblbtn tblremove">
        <i style="margin: 0em 0.2em;" class="fa fa-ban"></i>
    </a>
    <a href="https://toyyibpay.com/<?php echo $billcode; ?>" class="tblbtn tblpay">
        <i style="margin: 0em 0.2em;" class="fa fa-credit-card"></i>
    </a>
    <a href="<?php echo $gcal; ?>" class="tblbtn tblpay">
        <i style="margin: 0em 0.2em;" class="fab fa-google nav__icon"></i>
    </a>
</div>
