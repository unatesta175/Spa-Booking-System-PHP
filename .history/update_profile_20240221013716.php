...
if (isset($_POST['submit'])) {
   ...
   $update = $conn->prepare("UPDATE `clients` SET name = ?, ic = ?, email = ?, password = ?, phoneno = ? ,faculty_id = ? , datebirth= ? , address= ? , maritalstat= ?, religion= ?, occupation= ?, company= ?, company= ?, company= ?, company= ?WHERE student_id = ?");
