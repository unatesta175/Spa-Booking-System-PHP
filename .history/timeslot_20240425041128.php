      ...
      <div class="container">
         ...
         <div class="row"
            ...
            <?php if (!empty($_GET['date']) && !empty($_GET['staff'])): ?>
               <h1 id="selectedDate" class="text-center"></h1>
               <?php
   ...
   <script>
      document.addEventListener('DOMContentLoaded', function () {
         ...
         document.getElementById('datepicker').addEventListener('change', function () {
            ...
            // Additional text to be added to the <h1> element
            var additionalText = 'Tempah untuk tarikh : ';

            // Update the content of the <h1> element with the selected date and additional text
            document.getElementById('selectedDate').textContent = additionalText + selectedDate;
