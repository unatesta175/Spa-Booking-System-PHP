                  ...
                  <div class="card-body">
                     ...
                     <div class="row">
                       ...
                       $pay_stat = $row['pay_stat'];
                                       ...
                                       $select_accounts->execute([$service_id]);
                                       if ($select_accounts->rowCount() > 0) {
                                          while ($row = $select_accounts->fetch(PDO::FETCH_ASSOC)) {
                               ...
                               <td>
      <a href="client-accounts.php?delete=' . $id . '" onclick="return confirm(\'Adakah anda pasti untuk buang akaun ini? Maklumat berkaitan pengguna ini akan dibuang!\');" class="tblbtn tblremove"><i style="margin: 0em 0.2em;"class="fa fa-trash"></i>Buang</a>
