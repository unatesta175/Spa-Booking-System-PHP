                        ...
                        <tbody>
                           ...
                           if ($select_accounts->rowCount() > 0) {
                              while ($row = $select_accounts->fetch(PDO::FETCH_ASSOC)) {
                                 ...
                                 $dateTimeStart = '2024-05-20 14:30:00'; // Assuming this is a datetime value from your table
                                 $dateTimeEnd = '2024-05-20 16:00:00';   // Assuming this is a datetime value from your table
                                 
                                 // Convert datetime to the required format
                                 $startDateTime = new DateTime($dateTimeStart);
                                 $endDateTime = new DateTime($dateTimeEnd);
                                 
                                 $date = $startDateTime->format('Ymd'); // Get the date part in YYYYMMDD format
