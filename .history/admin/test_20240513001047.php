    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            function toggleDesigDropdown() {
                ...
                var desigDropdown = $("#service"); // Get staff dropdown element
        ...
        <div class="container">
            ...
            <div class="row">
                <form method="post" class="form-horizontal">
                    ...
                    <div class="col-sm-2">
                        <select name="department" class="form-control" id="staff">
                    ...
                    <div class="col-sm-2">
                        <select name="designation" class="form-control" id="service">
                            <option>---Select---</option>
                            <?php
