...
if (isset($_POST['submit'])) {
   ...
   if (!$booking_allowed || count(array_unique($booked_staff_ids)) < count($existing_bookings)) {
      $msg = "<div class='alert alert-danger'>Anda tidak boleh menempah slot masa ini dengan kakitangan yang sama atau sudah ada tempahan bertindih untuk kakitangan yang dipilih!</div>";
   } else {
   ...
   Anda tidak boleh menempah slot masa ini dengan kakitangan yang sama atau sudah ada tempahan bertindih untuk kakitangan yang dipilih!

Anda Tidak boleh menempah pada slot masa ini dengan
}
