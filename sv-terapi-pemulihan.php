...
<body>
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="height:40rem;">
                  ...
                  <div class="content">
                     ...
                     <h3>Terapi Pemulihan</h3>
                     <br>
                     <span>Pulihkan pergerakan tubuh anda dengan rawatan pemulihan profesional. Kurangkan rasa sakit dan tingkatkan kelenturan untuk kehidupan yang lebih aktif dan berkualiti bersama keluarga tercinta.</span>
                     <br>
   ...
   <section id="main" class="show-services">
     ...
     $select_products->execute([('fisioterapi')]);
         if ($select_products->rowCount() > 0) {
            while ($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)) {
               ...
               <div class="box">
                  ...
                  <div class="flex-btn">
                     <a href="booking.php?service_id=<?= $fetch_products['id']; ?>" class="btn">Tempah</a>
