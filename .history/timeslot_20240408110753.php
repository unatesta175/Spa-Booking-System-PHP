...
document.getElementById('service_id').addEventListener('change', function () {
    ...
    // Update the duration_service variable
    duration_service = duration;
    ...
    // Store the selected service ID and duration in localStorage
    var selectedServiceId = this.value;
    localStorage.setItem('selectedServiceId', selectedServiceId);
    localStorage.setItem('durationService', duration);
