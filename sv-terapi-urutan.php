...
<body>
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="height:40rem;">
                  ...
                  <div class="content">
                     ...
                     <h3>Terapi Urutan</h3>
                     <br>
                     <span>Segarkan jiwa dan raga dengan sentuhan urutan terapeutik yang menenangkan. Rangsang keupayaan pemulihan semula jadi tubuh anda dan capai keseimbangan fizikal serta mental yang optimum.</span>
                     <br>
   ...
   <section id="main" class="show-services">
     ...
     $select_products->execute([('urutan badan')]);
