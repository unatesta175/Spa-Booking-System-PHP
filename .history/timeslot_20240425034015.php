...
<body>
   ...
   <script>
      document.addEventListener('DOMContentLoaded', function () {
         ...
         document.getElementById('datepicker').addEventListener('change', function () {
            ...
            var url = window.location.pathname + '?' + 'date=' + selectedDate;
   ...
   <script>
    document.addEventListener('DOMContentLoaded', function () {
        // Check if both date and staff ID are set in the URL parameters
        var params = new URLSearchParams(window.location.search);
        var dateParam = params.get('date');
        var staffParam = params.get('staff');

        if (dateParam && staffParam) {
            // Both date and staff ID are set, so show the timeslots container
            document.getElementById('timeslotsContainer').style.display = 'block';
        }
    });
</script>
