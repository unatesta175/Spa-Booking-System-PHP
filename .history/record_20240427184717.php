...
<body>
   ...
   <div class="section">
                        ...
                        <div class="col-sm-12 table-responsive">
                           <table id="myTable" class="table table-bordered table-striped">
                              ...
                              <tbody>
                               ...
                               <td <?php if ($pay_stat == "Belum Bayar"): ?> class="red-button"<?php endif; ?>><?php echo $pay_stat; ?></td>
      ...
      <a href="client-accounts.php?delete=' . $id . '" onclick="return confirm(\'Adakah anda pasti untuk buang akaun ini? Maklumat berkaitan pengguna ini akan dibuang!\');" class="tbl-btn">Delete</a>
