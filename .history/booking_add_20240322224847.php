...
<body>
   ...
   <script>
    ...
    if (clickedDate.getDay() === 2) { // Check if clicked date is Tuesday
        // Show alert message in the div element
        var alertDiv = document.getElementById('info-alert');
        alertDiv.innerHTML = '<div class="alert alert-info" role="alert">Tiada Tempahan Tersedia pada Hari Selasa.</div>';
    } else {
