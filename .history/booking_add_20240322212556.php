...
<head>
   ...
   background-color: lightblue; /* Change background color on hover */
    ...
    .calendar {
        margin: 10px !important; /* Add some margin between calendars */
    }
}
      .container {
            display: flex;
        ...
        .calendar {
            flex: 20; /* Each calendar takes up 20% of the container width */
            margin: 10px; /* Add some margin between calendars */
        }

        /* Media query for mobile devices */
        @media only screen and (max-width: 600px) {
            .calendar {
                flex: 100%; /* Each calendar takes up 100% of the container width */
            }
        }
...
<body>
  ...
  <section>
   ...
   // Check if the mouse is over a date cell
   if (e.target.classList.contains('fc-daygrid-day')) {
      // Apply darker background color on hover
      e.target.style.backgroundColor = '#c0c0c0'; // Change to darker color
   }
});

// Event listener for mouseout on calendar1 cells
calendarEl1.addEventListener('mouseout', function (e) {
   // Check if the mouse leaves a date cell
   if (e.target.classList.contains('fc-daygrid-day')) {
      // Remove background color on mouseout
      e.target.style.backgroundColor = ''; // Remove background color
   }
});
    });
    ...
    // Function to navigate to timeGridDay view
     // Function to navigate to timeGridDay view and pass the date to calendar2
