...
<div align="center" class="container py-5 my-5 col-5">
    ...
    <h1 >Subscribe Now ! </h1>
                    <input type="text" hidden value="tiber"  name="name"  placeholder="Name" > <br><br>
                    <input type="email" hidden value="tiber" name="email"  placeholder="E-mail" required="required"><br><br>
