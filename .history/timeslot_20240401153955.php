...
<h4 class="modal-title">Tempah: <span id="slot"></slot></h4>
      </div>
      <div class="modal-body">
        <div class="row"><div class="col-md-12"><form action="" method="post"> <div class="form-group"> <label for="">Timeslot</label><input type="text"></div></form></div></div>
      </div>
