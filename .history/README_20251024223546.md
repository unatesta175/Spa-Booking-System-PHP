...
### Backend
- **PHP 8.x** - Server-side logic (Pure PHP, no frameworks)
- **MySQL 8.0** - Database management
- **PDO** - Secure database connections with prepared statements

### Frontend
- **HTML5** - Semantic markup
- **CSS3** - Custom styling (no Bootstrap dependency in main app)
- **JavaScript (ES6)** - Client-side interactivity
- **jQuery** - DOM manipulation and AJAX

### Libraries & Plugins
- **FullCalendar.js** - Interactive booking calendar
...
### Payment Gateway
- **ToyyibPay API** - Malaysian payment processor
