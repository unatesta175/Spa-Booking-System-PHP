...
<section class="form-container">
   ...
   <form action="" method="post">
    ...
    <label for="passLogins">Kata Laluan Pengesahan:<span style="color: red;">*</span></label>
    <div class="password-container">
    <input type="password" id="passLogin" name="cpass" required placeholder="Masukkan kata laluan pengesahan anda" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
    <i style="font-size:160%;"id="togglePasswords" class="fas fa-eye"></i>
    </div>
