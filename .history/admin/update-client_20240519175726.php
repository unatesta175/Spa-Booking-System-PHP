...
if (isset($_POST['update'])) {
   ...
   $update->execute([$name, $ic, $phoneno, $datebirth, $address, $maritalstat,$religion,$occupation,$company,$fb,$ig, $allergy, $user_id]);
...
<input type="text" id="otherOccupation" name="otherOccupation" style="display:none;" placeholder="Masukkan pekerjaan anda" class="box">
    ...
    <span for="fb">Facebook Username</span>
    ...
    <span for="ig">Instagram Username</span>
    ...
    <span for="allergy">Alahan<span style="color: red;"></span> Tulis 'tiada' jika tiada alahan</span>
