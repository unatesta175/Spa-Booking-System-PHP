...
<section class="home">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img loading="lazy" src="images/h1.png" alt="">
         </div>
         <div class="content">
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img loading="lazy" src="images/h2.png" alt="">
         </div>
         <div class="content">
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img loading="lazy" src="images/h4.png" alt="">
         </div>
         <div class="content">
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img loading="lazy" src="images/h5.png" alt="">
         </div>
         <div class="content">
...
<section class="home-products">
   ...
   <form action="" method="post" class="swiper-slide slide">
      ...
      <img loading="lazy" src="uploaded_img/<?= $fetch_product['image_01']; ?>" alt="">
