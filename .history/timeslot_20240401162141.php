...
<body>
   ...
   <div id="myModal" class="modal fade" role="dialog">
     ...
     <div style="border-radius:25px;"class="modal-content">
            ...
            <h1  style="font-size:2rem  !important;  font-family: 'Gilroymedium', sans-serif !important;"class="modal-title">Tempah: <span style= "bold font-size:2rem !important;" id="slot"></h1>
            <br>
