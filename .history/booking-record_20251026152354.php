                           ...
                           if ($select_accounts->rowCount() > 0) {
                              while ($row = $select_accounts->fetch(PDO::FETCH_ASSOC)) {
                               ...
                               if ($bookingstat != 'Batal' && $bookingstat != 'Selesai') {
                                  echo '<a data-tippy-content="Batalkan Tempahan" href="booking-record.php?delete=' . $id . '" onclick="return confirm(\'Adakah anda pasti untuk batalkan tempahan ini?\');" class="tblbtn tblremove"><i style="margin: 0em 0.2em;" class="fa fa-ban"></i></a>';
                               }
