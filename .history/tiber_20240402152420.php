  ...
  $calendar .= "
    ...
    <div class='row'>
     ...
     <label> Select Staff</label>
      <select class='form-control' id='staff_select' onchange='changeStaff(this.value)'>
    " . $rooms . "
      </select>
     </div>
     </div>
...
$totalbookings = checkSlots($conn, $date,$selectedStaff);
        if ($totalbookings == 36) {
            ...
            $availableslots = 36 - $totalbookings;
            $calendar .= "<td class='$today'><h4>$currentDay</h4><a href='timeslot.php?date=$date&staff_id=$selectedStaff' class='btns btn-success btn-xs'>Tempah</a><br> <span><i>$availableslots slots left</i></span></td>";
