...
.fc-header-toolbar {
    background-color: #your_color_here; /* Change to the desired background color */
}
...
<body>
   ...
   <script>
    ...
    if (clickedDate.getDay() === 2) { // Check if clicked date is Tuesday
      ...
      var selectedDateText = 'You have selected ' + clickedDate.toLocaleDateString('ms-MY', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' });
