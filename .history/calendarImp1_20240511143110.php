...
<body>
   ...
   <script>
    ...
    var eventLocation = info.event.extendedProps.location; // Additional property for location
    var eventAttendees = info.event.extendedProps.attendees; // Additional property for attendees
    var eventNotes = info.event.extendedProps.notes; // Additional property for notes
    var eventStatus = info.event.extendedProps.status; // Additional property for status

    Swal.fire({
        title: 'Maklumat Tempahan!',
        html: '<b>Pakej Rawatan dipilih:</b> ' + eventTitle + 
              '<br><b>Description:</b> ' + eventDescription + 
              '<br><b>ID:</b> ' + eventId + 
              '<br><b>Location:</b> ' + eventLocation + 
              '<br><b>Attendees:</b> ' + eventAttendees + 
              '<br><b>Notes:</b> ' + eventNotes + 
              '<br><b>Status:</b> ' + eventStatus,
        icon: 'info',
