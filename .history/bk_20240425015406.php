...
<body>
    ...
    <script>
        ...
        $('#bookingForm').submit(function(e) {
            ...
            var queryString = $(this).serialize(); // Serialize all the form data
            window.location.href = window.location.pathname + '?' + queryString; // Redirect to the same page with query string
        });
    });
    </script>
    <script>
