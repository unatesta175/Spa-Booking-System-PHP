...
<body>
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="height:40rem;">
                  ...
                  <div class="content">
                     ...
                     <h3>Pakej Terapi Badan</h3>
                     <br>
                     <span>Kembalikan tenaga dan semangat hidup dengan pakej spa istimewa kami. Rangkaian rawatan lengkap termasuk urutan, penjagaan muka dan mandian tersedia untuk anda pada nilai yang berbaloi.</span>
                     <br>
   ...
   <section id="main" class="show-services">
      ...
      <div class="box-container">
         ...
         $select_products->execute([('pakej spa')]);
