...
if(isset($_POST['submit'])){
   ...
   if($old_pass == $empty_pass){
      $message[] = 'please enter old password!'; Sila masukkan kata laluan lama
   }elseif($old_pass != $prev_pass){
      $message[] = 'old password not matched!'; Kata laluan lama tidak sepadan
   }elseif($new_pass != $cpass){
      $message[] = 'confirm password not matched!'; Kata laluan pengesahan tidak sepadan
   }else{
