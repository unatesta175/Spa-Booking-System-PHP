...
<body>
 ...
 <script>
    document.addEventListener('DOMContentLoaded', function () {
        // Function to set datepicker value from local storage
        function setDatepickerValueFromStorage() {
            // Retrieve the stored date from local storage
            var storedSelectedDate = localStorage.getItem('selectedDate');

            // If a date is stored, set the datepicker input value to the stored date
            if (storedSelectedDate) {
                document.getElementById('datepicker').value = storedSelectedDate;
            }
        }

        // Set datepicker value from local storage when the page loads
        setDatepickerValueFromStorage();
