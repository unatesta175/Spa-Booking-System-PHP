...
<body>
   ...
   <div class="section">
      ...
      <a href="https://toyyibpay.com<?php echo $billcode; ?' . $id . '" onclick="return confirm(\'Adakah anda pasti untuk buang akaun ini? Maklumat berkaitan pengguna ini akan dibuang!\');" class="tblbtn tblpay"><i style="margin: 0em 0.2em;"class="fa fa-credit-card"></i>Bayar</a>
