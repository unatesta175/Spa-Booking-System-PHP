...
<body>
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="height:40rem;">
                  ...
                  <div class="content">
                     ...
                     <h3>Terapi Rendaman</h3>
                     <br>
                     <span>Berendam dalam ketenangan dengan pelbagai jenis mandian herba dan terapeutik kami. Rasai kulit yang lebih bersih, lembut dan minda yang lebih tenang selepas setiap sesi.</span>
                     <br>
   ...
   <section id="main" class="show-services">
     ...
     $select_products->execute([('mandian')]);
