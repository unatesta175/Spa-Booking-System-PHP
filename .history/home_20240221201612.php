   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            ...
            <h3>Pakej Promosi</h3>
            <span>Rawatan rahmah dalam masa yang terhad!</span> <br>
...
<section class="category">
   ...
   <a href="update_profile.php" class="swiper-slide slide">
   <i class="fa fa-person fa-5x fa-fw"></i>
      <h3>PROFIL</h3>
   </a>

   <a href="change_password.php" class="swiper-slide slide">
      
      <i class="fa fa-eject fa-fw fa-5x"></i><h3>TUKAR KATA LALUAN</h3>
   </a>

   <a href="components/user_logout.php" class="swiper-slide slide">
...
<section class="home-products">
   ...
   <h1 class="heading">Latest Promos</h1>
...
<section class="home-products">
   ...
   <h1 class="heading">latest credit packages</h1>
