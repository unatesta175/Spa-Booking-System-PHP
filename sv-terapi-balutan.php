...
<body>
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="height:40rem;">
                  ...
                  <div class="content">
                     ...
                     <h3>Terapi Balutan</h3>
                     <br>
                     <span>Rasai kesegaran tubuh dengan rawatan balutan menyeluruh yang membantu membersihkan kulit mati dan meningkatkan kelembapan secara mendalam. Badan anda akan berasa lebih segar, kencang dan rileks sepenuhnya.</span>
                     <br>
 ...
 $select_products->execute([('balutan badan')]);
         if ($select_products->rowCount() > 0) {
            while ($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)) {
               ...
               <div class="box">
                  ...
                  <div class="flex-btn">
                     <a href="booking.php?service_id=<?= $fetch_products['id']."&service_duration=".$fetch_products['duration']+30; ?>" class="btn">Tempah</a>
