...
<input type="text" id="otherOccupation" name="otherOccupation" style="display:none;" placeholder="Masukkan pekerjaan anda" class="box">
    ...
    <input value="<?php echo $fetch_products['religion']; ?>" type="text" id="company" name="company" placeholder="Masukkan nama syarikat anda jika ada" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
    
    <label for="fb">Facebook Username:</label>
    <input value="<?php echo $fetch_products['religion']; ?>" type="text" id="fb" name="fb" placeholder="Masukkan username facebook anda jika ada" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
    
    <label for="ig">Instagram Username:</label>
    <input value="<?php echo $fetch_products['religion']; ?>" type="text" id="ig" name="ig" placeholder="Masukkan username instagram anda jika ada" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
   
    <label for="allergy">Alahan:<span style="color: red;">*</span> Tulis 'tiada' jika tiada alahan</label>
    <input value="<?php echo $$fetch_products['religion']; ?>" type="text" id="allergy" name="allergy"  required placeholder="Nyatakan Alahan anda jika ada" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
