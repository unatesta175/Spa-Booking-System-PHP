...
function build_calendar($month, $year)
{
  ...
  while ($currentDay <= $numberDays) {
    ...
    if ($dayName === 'tuesday' && $date > date('Y-m-d')) {
      ...
      if ($totalbookings >= 2) {
      $calendar .= "<td class='$today'><h4>$currentDay</h4><a href='#'class='btns btn-success btn-xs'>Ditempah Sepenuhnya</a></td>";

      } else {
      $calendar .= "<td class='$today'><h4>$currentDay</h4><a href='timeslot.php?date=" . $date . "'class='btns btn-success btn-xs'>Tempah</a></td>";
