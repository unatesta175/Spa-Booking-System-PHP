...
<body>
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="height:40rem;">
                  ...
                  <div class="content">
                     ...
                     <h3>Terapi Wax</h3>
                     <br>
                     <span>Rasai kelembutan kulit yang tahan lama dengan perkhidmatan waxing profesional kami. Keluarkan bulu yang tidak diingini dan nikmati hasil yang licin serta pertumbuhan semula yang lebih halus.</span>
                     <br>
   ...
   <section id="main" class="show-services">
     ...
     $select_products->execute([('waxing')]);
