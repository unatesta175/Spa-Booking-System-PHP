...
<td>
    <a href="client-accounts.php?delete=<?php echo $id; ?>" onclick="return confirm('Adakah anda pasti untuk buang akaun ini? Maklumat berkaitan pengguna ini akan dibuang!');" class="tblbtn tblremove"><i style="margin: 0em 0.2em;" class="fa fa-ban"></i>Batal</a>
