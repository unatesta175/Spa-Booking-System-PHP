	...
	<div class="row">
      ...
      if($select_accounts->rowCount() > 0){
         while($row = $select_accounts->fetch(PDO::FETCH_ASSOC)){
                                 ...
                                 <button>
                                 <a href="users_accounts.php?delete=<?= $row['id']; ?>" onclick="return confirm('Delete this account? The user-related information will also be deleted!')" class="delete-btn">Delete</a>
                             </button>
											</center>
											</td>
                							</tr>';
