...
<body>
   ...
   font-weight: 800 !important;">Tempah Sesi Rawatan</h1>
                <div class="col-md-4 col-sm-6">
                    ...
                    <form id="makeAppoitment" action="javascript:void(0)" method="post" >
                    ...
                    <div class="section add-any">
                        <form id="registration_form" style="box-shadow: none;" action="javascript:void(0)" method="post">
                            ...
                            <?php
                            $select_accountss = $conn->prepare("SELECT * FROM `services` WHERE id=?");
                            $select_accountss->execute([$_GET['service_id']]);
                            if ($select_accountss->rowCount() > 0) {
                                while ($rows = $select_accountss->fetch(PDO::FETCH_ASSOC)) {

                                    $servicename = $rows['name'];
                                    $durationservice = $rows['duration'] + 30;
                                }
                            }
                            ...
                            <input name="service" hidden required value="<?php echo $_GET['service_id']; ?>" id="service">

                            <div class="inputBox">
                                <label>Pakej Rawatan Spa :</label>
                                <select name="servicess" disabled style="color:black; appearance: none;" placeholder="Pilih Pakej Rawatan" class="box" id="servicess">
                                    <option value="<?php echo $_GET['service_id']; ?>"><?php echo $servicename; ?></option>
                            ...
                            <div class="inputBox">
                                ...
                                <input readonly value="<?php echo formatDuration($durationservice); ?>" class="box" placeholder="Tempoh Masa" type="text" name="duration" id="duration">
                            </div>
                ...
                <div class="container mt-3">
                    <a href="javascript:void(0);" class="btns btn-secondary" onclick="history.back()">
