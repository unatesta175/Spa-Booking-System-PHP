...
$stmt->execute([$month, $year,$first_room]);
...
". $rooms ."
  ...
  if ($totalbookings == 1) {
        ...
        $calendar .= "<td class='$today'><h4>$currentDay</h4><a href='timeslot.php?date=" . $date . "'class='btns btn-success btn-xs'>Tempah</a><br>
         <span><i>$availableslots slots left</i></span></td>";
