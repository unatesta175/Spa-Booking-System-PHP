...
<section class="form-container">
   ...
   <form action="" method="post">
    ...
    <select id="maritalStatus" name="maritalStatus" required class="box">
  <option value="">--Pilih Status Perkahwinan Anda--</option>
  <option value="Bujang">Bujang (Single)</option>
  <option value="Sudah berkahwin">Sudah Berkahwin (Married)</option>
  <option value="Bercerai">Bercerai (Divorced)</option>
  <option value="Janda">Janda (Widowed - Female)</option>
  <option value="Duda">Duda (Widowed - Male)</option>
  <option value="Bertunang">Bertunang (Engaged)</option>
</select>
