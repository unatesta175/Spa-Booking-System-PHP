...
if (isset($_SESSION['delete'])) {
   ...
   $bookdeleteScript = "<script>
           window.onload = function() {
               Swal.fire({
                   title: 'Berjaya!',
                   text: 'Tempahan sudah dibatalkan!',
                   icon: 'success',
...
<body>
   ...
   ?>
   <?php echo $bookSuccessScript; echo $bookdeleteScript;?>
   <div class="section">
      <br>
      <!-- start of Tables -->
      <div class="container">
                        ...
                        <div class="col-sm-12 table-responsive">
                           <table id="myTable" class="table table-bordered table-striped">
                              ...
                              <tbody>
                               ...
                               <td>
      <a href="record.php?delete=' . $id . '" onclick="return confirm(\'Adakah anda pasti untuk buang akaun ini? Maklumat berkaitan pengguna ini akan dibuang!\');" class="tblbtn tblremove"><i style="margin: 0em 0.2em;"class="fa fa-ban"></i>Batal</a>
