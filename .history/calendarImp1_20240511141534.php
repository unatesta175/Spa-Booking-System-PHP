            ...
            var eventId = info.event.extendedProps.id;
               ...
               Swal.fire({
                  ...
                  //  text: 'Anda sudah berjaya log masuk!',
                    ...
                    html: '<b>Pakej Rawatan dipilih:</b> ' + eventTitle + '<br><b>Description:</b> ' + eventDescription + '<br><b>ID:</b> ' + eventId,
                   icon: 'info',
