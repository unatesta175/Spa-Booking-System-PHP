            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="height:40rem;">
                  ...
                  <div class="content">
                     ...
                     <h3>Pakej Spa</h3>
                     <br>
                     <span>Pengalaman spa yang unik untuk mengembalikan tenaga anda. Kapas menawarkan pakej yang lengkap
                        – lengkap dengan urutan badan, rawatan muka, pakej mandian pada harga yang istimewa.</span>
                     <br>
         ...
         if ($select_products->rowCount() > 0) {
            while ($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)) {
               ...
               <div class="box">
                  ...
                  <div class="flex-btn">
                     <a href="update-service.php?update=<?= $fetch_products['id']; ?>" class="option-btn">Tempah</a>
