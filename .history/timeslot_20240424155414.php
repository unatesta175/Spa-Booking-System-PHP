...
<?php } ?>
   ...
   <script>
      ...
      if (!localStorage.getItem('pageLoaded')) {
        ...
        // Set the selected value of the staff select input to an empty string to display the placeholder text
        document.getElementById('staff_id').value = '';
    } else {
        // If the page has been loaded before, set the selected value based on the stored staff ID
