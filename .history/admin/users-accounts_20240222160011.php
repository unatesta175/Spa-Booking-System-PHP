               ...
               <div class="card-header">
                  <div class="row">
                     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-6">
                        <h3 class="card-title">Senarai Client</h3>
                     </div>
                                 ...
                                 while ($row = $select_accounts->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    echo '<tr>
                							...
                							<td>' . $email . '</td>
               								...
               								<td>
                                       <center><a class=" underline" style="font-size: 1.5em;" href="users-accounts.php?delete=' . $id . '" onclick="return confirm(`delete this account? the user related information will also be delete!"> <center><i class=" fa fa-trash" style="color:red">
                                       </i></center></a>&nbsp;&nbsp;&nbsp;&nbsp;</center>
											</td>
                							</tr>';
                                    $no++;
