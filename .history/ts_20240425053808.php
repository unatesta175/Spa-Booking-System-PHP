...
<body>
   ...
   <div class="section">
    ...
    <?php
<div class="row" id="timeslotsContainer" style="background-color:white; border-radius: 25px; padding:15px; box-shadow: var(--box-shadow);">
    <?php if (isset($_GET['date']) && isset($_GET['staff'])): ?>
        <?php
