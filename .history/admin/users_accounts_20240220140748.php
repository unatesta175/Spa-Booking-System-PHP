      ...
      if($select_accounts->rowCount() > 0){
         while($row = $select_accounts->fetch(PDO::FETCH_ASSOC)){
											...
											<center>
												...
												<button> <a href="users_accounts.php?delete=<?= $row['id']; ?>" onclick="return confirm('delete this account? the user related information will also be delete!')" class="delete-btn">delete</a></button>
											</center>
											</td>href="application_delete.php?application_id=' . $application_id . '"
                							</tr>';
											$no++;
										}
									}
