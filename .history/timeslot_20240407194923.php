...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var timeslotContainer = document.querySelector(".timeslot-container");
    ...
    staffSelect.addEventListener("change", function() {
        ...
        xhr.open("GET", "fetch_timeslots.php?staff=" + staffId, true);
            ...
            if (xhr.status >= 200 && xhr.status < 300) {
                ...
                if (timeslots.length > 0) {
                    timeslots.forEach(function(timeslot) {
                        timeslotContainer.innerHTML += '<button class="btns btn-danger book" data-timeslot="' + timeslot + '">' + timeslot + '</button>';
                    });
                } else {
                    timeslotContainer.innerHTML = "<p>No timeslots available for this staff.</p>";
                }
            } else {
