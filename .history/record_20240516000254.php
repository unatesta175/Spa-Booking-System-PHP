...
<body>
   ...
   <div class="section">
      ...
      <a href="https://dev.toyyibpay.com/' . $billcode . '" class="tblbtn tblpay"><i style="margin: 0em 0.2em;"class="fa fa-credit-card"></i>Bayar</a>
   ...
   <script>
      document.getElementById("pdf-btn").addEventListener("click", function() {
         ...
         const headers = [
            ["No.", "ID", "Nama", "I/C", "Emel", "No.Tel", "Tarikh Lahir", "Alamat", "Status Perkahwinan", "Agama", "Pekerjaan", "Syarikat", "FBN", "IGN", "Alahan"]
         ];
