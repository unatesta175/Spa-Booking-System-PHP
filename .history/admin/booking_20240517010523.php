...
<body>
   ...
   font-weight: 800 !important;">Tempah Sesi Rawatan</h1>
                    ...
                    <div class="section add-any">
                        <form id="registration_form" style="box-shadow: none;" action="javascript:void(0)" method="post">
                            ...
                            <div class="inputBox">
                                ...
                                <input aria-readonly style="font-family: 'Gilroymedium', sans-serif;" readonly style="font-size:1.3rem;" type="text"  name="timeslot" id="timeslotz" class="box" placeholder="Slot Masa">
                            </div>
    ...
    $("#Submit").click(function(e) {
        ...
        if (client === "Pilih Pengguna" || date === "Date" || staff === "Pilih Pakar Terapi" || service === "Pilih Pakej Rawatan" || duration === "Tempoh Masa" || timeslot === "Slot Masa" ) {
            ...
            Swal.fire({
                ...
                text: 'Adakah anda pasti untuk menempah?',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Ya, Saya ingin menempah !',
