...
<body>
   ...
   <section>
   <div class="alert alert-info selected-date" role="alert">
</div>
   ...
   <script>
    ...
    if (clickedDate.getDay() === 2) { // Check if clicked date is Tuesday
        // Display alert message for Tuesdays
        document.getElementById('selected-date').innerHTML = '<div class="alert alert-info" role="alert">Tiada Tempahan Tersedia pada Hari Selasa.</div>';
    } else {
        var selectedDateText = 'Anda Sudah Pilih ' + clickedDate.toLocaleDateString('ms-MY', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' });
        document.getElementById('selected-date').innerHTML = '<div class="alert alert-info" role="alert">' + selectedDateText + '</div>';
        calendar2.gotoDate(dateStr);
        calendar2.changeView('timeGridDay');
    }
}
