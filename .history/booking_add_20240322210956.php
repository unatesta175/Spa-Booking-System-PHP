...
var calendar2 = new FullCalendar.Calendar(calendarEl2, {
    // Configure options for calendar 2
...
// Event listeners for time slot cells in calendar 2
...
var calendar1 = new FullCalendar.Calendar(calendarEl1, {
    // Configure options for calendar 1
    ...
    hiddenDays: [2], // Hide Tuesdays
    dayCellContent: function (info) {
        // Customize content for each date cell in calendar 1
    ...
    slotLaneContent: function (slotLaneInfo) {
        // Customize content for each slot lane in calendar 1
        if (calendar1.view.type === 'timeGridDay' && slotLaneInfo.date.getDay() === 2) {
            return ''; // Return empty content for Tuesdays in timeGridDay view
        } else {
...
// Function to navigate to timeGridDay view in calendar 2
function goToTimeGridDay(dateStr) {
    calendar2.gotoDate(dateStr); // Set the calendar date to the clicked date
