                    ...
                    <div class="section add-any">
                        <form id="registration_form" style="box-shadow: none;" action="javascript:void(0)" method="post">
                            <div class="inputBox">
                                ...
                                <select class="box" disabled style="color:black; appearance: none;" required placeholder="Pilih Pakar Terapi" name="staffss" class="form-control" id="staffss">
                                    <option value="<?php echo $staff_id; ?>"><?php echo $staffname; ?></option>

                                </select>

                            </div>

                            <input name="staff" hidden required value="<?php echo $staff_id; ?>" id="staff">
                            <div class="inputBox">
    ...
    <script>
        $(document).ready(function() {
            $("#Submit").click(function(e) {
                ...
                if (client === "Pilih Pengguna" || date === "Date" || staff === "Pilih Pakar Terapi" || service === "Pilih Pakej Rawatan" || duration === "Tempoh Masa" ) {
