...
<script>const passwordInput = document.getElementById("old_pass");
const togglePassword = document.getElementById("togglePasswordx");
...
<script>const passwordInput = document.getElementById("new_pass");
const togglePassword = document.getElementById("togglePasswordy");
...
<script>const passwordInput = document.getElementById("cpass");
const togglePassword = document.getElementById("togglePasswordz");
