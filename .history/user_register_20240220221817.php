...
<section class="form-container">
   ...
   <form action="" method="post">
    ...
    <input type="text" id="address" name="address"  required placeholder="Masukkan alamat kediaman anda" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
   
    <label for="maritalstat">Status Perkahwinan:<span style="color: red;">*</span></label>
    <input type="text" id="maritalstat" name="maritalstat"  required placeholder="" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
    
    <label for="religion">Agama:<span style="color: red;">*</span></label>
    <input type="text" id="religion" name="religion"  required placeholder="Masukkan agama anda" maxlength="70" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
