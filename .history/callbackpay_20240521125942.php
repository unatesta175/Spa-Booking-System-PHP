...
function callbackPayCode()
{
    ...
    if ($status_id == 1) {
        ...
        $_SESSION['paid'] = "Pembayaran berjaya dibuat. Sila ambil perhatian dengan tarikh slot rawatan. Terima Kasih.";
        ...
        $_SESSION['error'] = "Gagal membuat pembayaran. Sila cuba lagi atau hubungi sokongan kami untuk bantuan.";
        header("Location: booking-record.php");
        exit;
    }
}
