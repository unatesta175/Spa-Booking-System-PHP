    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#service").change(function() {
                ...
                // Make an AJAX request to get the duration from getduration.php
    $.ajax({
        url: 'getduration.php', // URL of getduration.php
        type: 'POST', // Method type
        data: { servicev1: servicev }, // Data to be sent to the server
        success: function(response) {
            // This function executes when the AJAX request is successful
            console.log('Duration loaded successfully:', response);
            // Set the value of #duration input field with the response
            $("#duration").val(response);
        },
        error: function(xhr, status, error) {
            // This function executes if the AJAX request encounters an error
