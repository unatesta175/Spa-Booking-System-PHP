                           ...
                           <table id="myTable" class="table table-bordered table-striped">
                              ...
                              <tbody>
                               ...
                               if ($pay_stat == "Belum Bayar"): ?>
                                   <a class="tblbtn">Belum Bayar</a>
                               <?php else: ?>
                                   <a class="greenbtn">Sudah Bayar</a>
                               <?php endif;
                               $button_html = ob_get_clean(); // Capture the output and clear the buffer
                               echo $button_html; // Output the captured HTML
                               ?>
                           </td>
